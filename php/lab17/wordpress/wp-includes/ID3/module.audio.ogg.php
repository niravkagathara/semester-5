...
{
	/**
	 * @link http://xiph.org/vorbis/doc/Vorbis_I_spec.php
	 *
	 * @return bool
	 */
...
$this->warning('Ogg Theora (v3) not fully supported in this version of getID3 ['.$this->getid3->version().'] -- bitrate, playtime and all audio data are currently unavailable');
			...
			// http://xiph.org/ogg/doc/skeleton.php
			$filedataoffset += 8;
			...
			// https://xiph.org/flac/ogg_mapping.php
	...
	public function ParseOggPageHeader() {
		// http://xiph.org/ogg/vorbis/doc/framing.php
		$oggheader = array();
	...
	/**
	 * @link http://xiph.org/vorbis/doc/Vorbis_I_spec.php#x1-810005
	 *
	 * @return bool
	 */
		...
		for ($i = 0; $i < $CommentsCount; $i++) {
			...
			if (!$commentstring) {
				...
				if ($ThisFileInfo_ogg_comments_raw[$i]['key'] == 'METADATA_BLOCK_PICTURE') {
					...
					// http://flac.sourceforge.net/format.php#metadata_block_picture
					$flac = new getid3_flac($this->getid3);
