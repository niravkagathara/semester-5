		...
		if (substr($atomname, 0, 3) == "\x00\x00\x00") {
			...
			switch ($atomname) {
				...
				case 'cmvd': // Compressed MooV Data atom
					...
					// http://developer.apple.com/quicktime/icefloe/dispatch012.php
...
$this->warning('incomplete/incorrect handling of "stsd" with Parrot metadata in this version of getID3() ['.$this->getid3->version().']');
						...
						switch ($atom_structure['sample_description_table'][$i]['encoder_vendor']) {
							...
							case "\x00\x00\x00\x00":
								...
								// video tracks
								// http://developer.apple.com/library/mac/#documentation/QuickTime/QTFF/QTFFChap3/qtff3.php
...
//					if (true) {
				...
				case 'tkhd': // TracK HeaDer atom
					...
					// http://developer.apple.com/library/mac/#documentation/QuickTime/RM/MovieBasics/MTEditing/K-Chapter/11MatrixFunctions.php
					// http://developer.apple.com/library/mac/#documentation/QuickTime/qtff/QTFFChap4/qtff4.php#//apple_ref/doc/uid/TP40000939-CH206-18737
				...
				case 'iods': // Initial Object DeScriptor atom
					...
					// http://libquicktime.sourcearchive.com/documentation/1.0.2plus-pdebian/iods_8c-source.php
					$offset = 0;
	...
	/* due to lack of known documentation, this is a kludge implementation. If you know of documentation on how mdat is properly structed, please send it to info@getid3.org */
				...
				case 'nsav': // NoSAVe atom
					// http://developer.apple.com/technotes/tn/tn2038.php
				...
				case 'PrmA':
				case 'code':
				case 'FIEL': // this is NOT "fiel" (Field Ordering) as describe here: http://developer.apple.com/documentation/QuickTime/QTFF/QTFFChap3/chapter_4_section_2.php
				case 'tapt': // TrackApertureModeDimensionsAID - http://developer.apple.com/documentation/QuickTime/Reference/QT7-1_Update_Reference/Constants/Constants.php
							// tapt seems to be used to compute the video size [https://www.getid3.org/phpBB3/viewtopic.php?t=838]
							// * http://lists.apple.com/archives/quicktime-api/2006/Aug/msg00014.php
							// * http://handbrake.fr/irclogs/handbrake-dev/handbrake-dev20080128_pg2.php
				case 'ctts'://  STCompositionOffsetAID             - http://developer.apple.com/documentation/QuickTime/Reference/QTRef_Constants/Reference/reference.php
				case 'cslg'://  STCompositionShiftLeastGreatestAID - http://developer.apple.com/documentation/QuickTime/Reference/QTRef_Constants/Reference/reference.php
				case 'sdtp'://  STSampleDependencyAID              - http://developer.apple.com/documentation/QuickTime/Reference/QTRef_Constants/Reference/reference.php
				case 'stps'://  STPartialSyncSampleAID             - http://developer.apple.com/documentation/QuickTime/Reference/QTRef_Constants/Reference/reference.php
					//$atom_structure['data'] = $atom_data;
					break;
				...
				case 'NCDT':
					// https://exiftool.org/TagNames/Nikon.php
				...
				case 'NCM2': // Nikon Camera preview iMage 2
					...
					break;
				case 'NCTG': // Nikon - https://exiftool.org/TagNames/Nikon.php#NCTG
					...
					break;
				case 'NCHD': // Nikon:MakerNoteVersion  - https://exiftool.org/TagNames/Nikon.php
					$makerNoteVersion = '';
					...
					break;
				case 'NCDB': // Nikon                   - https://exiftool.org/TagNames/Nikon.php
				case 'CNCV': // Canon:CompressorVersion - https://exiftool.org/TagNames/Canon.php
					$atom_structure['data'] = $atom_data;
					break;
				...
				case 'meta': // METAdata atom
					// https://developer.apple.com/library/mac/documentation/QuickTime/QTFF/Metadata/Metadata.php
				...
				case 'keys': // KEYS that may be present in the metadata atom.
					// https://developer.apple.com/library/mac/documentation/QuickTime/QTFF/Metadata/Metadata.php#//apple_ref/doc/uid/TP40000939-CH1-SW21
				...
				case 'frea':
					// https://www.sno.phy.queensu.ca/~phil/exiftool/TagNames/Kodak.php#frea
...
// AVIF-related - https://docs.rs/avif-parse/0.13.2/src/avif_parse/boxes.rs.php
...
$this->error('fragmented mp4 files not currently supported');
	...
	public function quicktime_read_mp4_descr_length($data, &$offset) {
		// http://libquicktime.sourcearchive.com/documentation/2:1.0.2plus-pdebian-2build1/esds_8c-source.php
		$num_bytes = 0;
		$length    = 0;
		do {
	...
	public function QuicktimeLanguageLookup($languageid) {
		// http://developer.apple.com/library/mac/#documentation/QuickTime/QTFF/QTFFChap4/qtff4.php#//apple_ref/doc/uid/TP40000939-CH206-34353
	...
	public function CopyToAppropriateCommentsSection($keyname, $data, $boxname='') {
		...
		if (empty($handyatomtranslatorarray)) {
			...
			// http://atomicparsley.sourceforge.net/mpeg-4files.php
			// https://code.google.com/p/mp4v2/wiki/iTunesMetadata
			...
			// http://age.hobba.nl/audio/tag_frame_reference.php
