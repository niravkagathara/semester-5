...
define('EBML_ID_TAGS',                      0x0254C367); // [12][54][C3][67] -- Element containing elements specific to Tracks/Chapters. A list of valid tags can be found <http://www.matroska.org/technical/specs/tagging/index.php>.
...
/**
* @tutorial http://www.matroska.org/technical/specs/index.php
*
...
class getid3_matroska extends getid3_handler
{
	...
	private function parseEBML(&$info) {
		// http://www.matroska.org/technical/specs/index.php#EBMLBasics
	...
	private function HandleEMBLClusterBlock($element, $block_type, &$info) {
		// http://www.matroska.org/technical/specs/index.php#block_structure
		// http://www.matroska.org/technical/specs/index.php#simpleblock_structure
	...
	public static function TargetTypeValue($target_type) {
		// http://www.matroska.org/technical/specs/tagging/index.php
	...
	public static function BlockLacingType($lacingtype) {
		// http://matroska.org/technical/specs/index.php#block_structure
	...
	public static function CodecIDtoCommonName($codecid) {
		// http://www.matroska.org/technical/specs/codecid/index.php
	...
	public static function displayUnit($value) {
		// http://www.matroska.org/technical/specs/index.php#DisplayUnit
		static $units = array(
			0 => 'pixels',
			1 => 'centimeters',
			2 => 'inches',
