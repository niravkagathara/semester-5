...
function stripTags(settings, text) {
  return text.replace(settings.phpRegExp, '\n');
}
...
function stripHTMLEntities(settings, text) {
  return text.replace(settings.phpEntityRegExp, '');
}
...
function stripHTMLComments(settings, text) {
  return text.replace(settings.phpcommentRegExp, '');
}
...
function transposeHTMLEntitiesToCountableChars(settings, text) {
  return text.replace(settings.phpEntityRegExp, 'a');
}
