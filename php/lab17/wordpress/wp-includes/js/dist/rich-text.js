 ...
 * @param {string}  [$1.php]                     HTML to create value from.
...
function to_dom_append(element, child) {
  if (child.php !== undefined) {
    return element.innerHTML += child.php;
  }
...
function applySelection({
  ...
  if (activeElement !== ownerDocument.activeElement) {
    ...
    if (activeElement instanceof defaultView.phpElement) {
      activeElement.focus();
    }
  }
}
 ...
 *
 * https://html.spec.whatwg.org/multipage/interaction.php#best-practices-for-in-page-editors
 *
 * @type {string}
 */
