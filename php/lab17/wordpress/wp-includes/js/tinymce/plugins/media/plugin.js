...
var media = (function () {
    ...
    var global$4 = tinymce.util.Tools.resolve('tinymce.php.SaxParser');
    ...
    var global$6 = tinymce.util.Tools.resolve('tinymce.php.Schema');

    var global$7 = tinymce.util.Tools.resolve('tinymce.php.Writer');
    ...
    var dataToHtml = function (editor, dataIn) {
      ...
      if (!data.source1) {
        global$2.extend(data, HtmlToData.phpToData(Settings.getScripts(editor), data.embed));
        if (!data.source1) {
          return '';
        }
      }
    ...
    var getData = function (editor) {
      ...
      return element.getAttribute('data-mce-object') ? HtmlToData.phpToData(Settings.getScripts(editor), editor.serializer.serialize(element, { selection: true })) : {};
    };
    ...
    var addEmbedHtml = function (win, editor) {
      return function (response) {
        ...
        var data = global$2.extend(HtmlToData.phpToData(Settings.getScripts(editor), html), { source1: response.url });
        win.fromJSON(data);
        if (embed) {
          embed.value(html);
    ...
    var showDialog = function (editor) {
      ...
      var updateValueOnChange = function () {
        data = global$2.extend({}, HtmlToData.phpToData(Settings.getScripts(editor), this.value()));
    ...
    var global$8 = tinymce.util.Tools.resolve('tinymce.php.Node');
