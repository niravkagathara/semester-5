...
( function( window, views, media, $ ) {
	...
	function verifyHTML( string ) {
		...
		schema = schema || new window.tinymce.php.Schema( settings );
		parser = parser || new window.tinymce.php.DomParser( settings, schema );
		serializer = serializer || new window.tinymce.php.Serializer( settings, schema );
