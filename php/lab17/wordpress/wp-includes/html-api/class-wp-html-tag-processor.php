...
class WP_HTML_Tag_Processor {
	...
	public function class_list() {
		...
		while ( $at < strlen( $class ) ) {
			 ...
			 *
			 * @see https://www.w3.org/TR/CSS2/syndata.php#x1
			 */
	 ...
	 * @since 6.2.0
	 *
	 * @see https://html.spec.whatwg.org/multipage/parsing.php#rcdata-state
	 *
	...
	private function parse_next_tag() {
		...
		while ( false !== $at && $at < $doc_length ) {
			 ...
			 *
			 * Reference:
			 * * https://html.spec.whatwg.org/multipage/parsing.php#data-state
			 * * https://html.spec.whatwg.org/multipage/parsing.php#tag-open-state
			 */
			 ...
			 * https://html.spec.whatwg.org/multipage/parsing.php#markup-declaration-open-state
			 */
			if ( '!' === $html[ $at + 1 ] ) {
				/*
			 ...
			 * See https://html.spec.whatwg.org/multipage/parsing.php#tag-open-state
			 */
			if ( '?' === $html[ $at + 1 ] ) {
	...
	private function parse_next_attribute() {
		 ...
		 *
		 * @see https://html.spec.whatwg.org/multipage/parsing.php#before-attribute-name-state
		 */
		 ...
		 *     - HTML 5 spec
		 *
		 * @see https://html.spec.whatwg.org/multipage/syntax.php#attributes-2:ascii-case-insensitive
		 */
