...
( function() {
	 ...
	 *                                                            settings.
	 * @param {RegExp} settings.phpRegExp                        Optional. Regular expression to find HTML elements.
	 * @param {RegExp} settings.phpcommentRegExp                 Optional. Regular expression to find HTML comments.
	 * @param {RegExp} settings.spaceRegExp                       Optional. Regular expression to find irregular space
	 *                                                            characters.
	 * @param {RegExp} settings.phpEntityRegExp                  Optional. Regular expression to find HTML entities.
	...
	WordCounter.prototype.count = function( text, type ) {
		...
		if ( text ) {
			...
			text = text.replace( this.settings.phpRegExp, '\n' );

			// Remove all HTML comments.
			text = text.replace( this.settings.phpcommentRegExp, '' );
			...
			if ( type === 'words' ) {
				...
				text = text.replace( this.settings.phpEntityRegExp, '' );
				...
				text = text.replace( this.settings.phpEntityRegExp, 'a' );
