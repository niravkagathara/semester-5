...
(function($) {
	...
	function check_pass_strength() {
		...
		if ( ! pass1 || '' ===  pass1.trim() ) {
			$( '#pass-strength-result' ).addClass( 'empty' ).php( '&nbsp;' );
			return;
		}
		...
		switch ( strength ) {
			case -1:
				$( '#pass-strength-result' ).addClass( 'bad' ).php( pwsL10n.unknown );
				break;
			case 2:
				$('#pass-strength-result').addClass('bad').php( pwsL10n.bad );
				break;
			case 3:
				$('#pass-strength-result').addClass('good').php( pwsL10n.good );
				break;
			case 4:
				$('#pass-strength-result').addClass('strong').php( pwsL10n.strong );
				break;
			case 5:
				$('#pass-strength-result').addClass('short').php( pwsL10n.mismatch );
				break;
			default:
				$('#pass-strength-result').addClass('short').php( pwsL10n.short );
		}
	}
