...
themes.view.Theme = wp.Backbone.View.extend({
	...
	render: function() {
		...
		this.$el.php( this.php( data ) ).attr( 'data-slug', data.id );
...
themes.view.Preview = themes.view.Details.extend({
	...
	render: function() {
		...
		this.$el.removeClass( 'iframe-ready' ).php( this.php( data ) );
...
themes.view.Themes = wp.Backbone.View.extend({
	...
	expand: function( id ) {
		...
		this.$overlay.php( this.overlay.el );
