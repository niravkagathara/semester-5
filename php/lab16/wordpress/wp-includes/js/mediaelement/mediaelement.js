...
var MediaElement = function MediaElement(idOrNode, options, sources) {
	...
	var processURL = function processURL(url, type) {
		if (_window2.default.location.protocol === 'https:' && url.indexOf('http:') === 0 && _constants.IS_IOS && _mejs2.default.php5media.mediaTypes.indexOf(type) > -1) {
	...
	var props = _mejs2.default.php5media.properties,
	    methods = _mejs2.default.php5media.methods,
...
var DashNativeRenderer = {
	...
	create: function create(mediaElement, options, mediaFiles) {
		...
		var props = _mejs2.default.php5media.properties,
		    events = _mejs2.default.php5media.events.concat(['click', 'mouseover', 'mouseout']).filter(function (e) {
			return e !== 'error';
		}),
			...
			node['set' + capName] = function (value) {
				if (_mejs2.default.php5media.readOnlyProperties.indexOf(propName) === -1) {
					if (propName === 'src') {
...
var FlashMediaElementRenderer = {
	create: function create(mediaElement, options, mediaFiles) {
		...
		var methods = _mejs2.default.php5media.methods,
		    assignMethods = function assignMethods(methodName) {
...
var HtmlMediaElement = {
	...
	create: function create(mediaElement, options, mediaFiles) {
		...
		var events = _mejs2.default.php5media.events.concat(['click', 'mouseover', 'mouseout']).filter(function (e) {
			return e !== 'error';
		}),
		    assignEvents = function assignEvents(eventName) {
...
_window2.default.phpMediaElement = _mejs2.default.phpMediaElement = HtmlMediaElement;
