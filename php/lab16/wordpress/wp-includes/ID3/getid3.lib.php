...
class getid3_lib
{
	...
	/**
	 * @link http://www.scri.fsu.edu/~jac/MAD3401/Backgrnd/binary.php
	 *
	...
	/**
	 * @link http://www.scri.fsu.edu/~jac/MAD3401/Backgrnd/ieee-expl.php
	 *
	 * @param float $floatvalue
	 * @param int $bits
	 *
	 ...
	 * @link http://www.scri.fsu.edu/~jac/MAD3401/Backgrnd/ieee.php
	 *
	 * @param string $byteword
	 *
	 * @return float|false
	...
	public static function XML2array($XMLstring) {
		if (function_exists('simplexml_load_string') && function_exists('libxml_disable_entity_loader')) {
			// http://websec.io/2012/08/27/Preventing-XEE-in-PHP.php
